...
export default function MessagesScreen({
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    closeButton: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: t.surface, borderWidth: 0.5, borderColor: t.border },
    ...
    unreadDot: { position: 'absolute', top: -3, right: -3, minWidth: 18, height: 18, borderRadius: 9, backgroundColor: t.danger, borderWidth: 2, borderColor: t.bg, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4 },
