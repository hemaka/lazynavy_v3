...
const styles = StyleSheet.create({
  ...
  playerHud: { marginLeft: 38, marginRight: 86, marginTop: 22, minHeight: 76, paddingLeft: 84, paddingRight: 14, paddingVertical: 10, borderRadius: 20, backgroundColor: 'rgba(235,248,255,0.72)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.72)', flexDirection: 'row', alignItems: 'center', shadowColor: '#075985', shadowOpacity: 0.16, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } },
  avatarWrap: { position: 'absolute', left: -34, top: -1, width: 78, height: 78 },
  avatar: { width: 78, height: 78, borderRadius: 39, backgroundColor: '#bfe9ff', borderWidth: 4, borderColor: colors.white, alignItems: 'center', justifyContent: 'center', shadowColor: '#075985', shadowOpacity: 0.22, shadowRadius: 12, shadowOffset: { width: 0, height: 6 } },
  avatarText: { color: colors.ink, fontWeight: '900', fontSize: 27 },
  playerMain: { flex: 1 },
  ...
  xpTrack: { height: 4, borderRadius: 2, backgroundColor: 'rgba(14,116,144,0.22)', overflow: 'hidden', marginTop: 7, maxWidth: width * 0.46 },
  ...
  messageButton: { position: 'absolute', right: 22, top: 34, width: 54, height: 54, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.28)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.76)', alignItems: 'center', justifyContent: 'center' },
