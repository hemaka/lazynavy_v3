...
const styles = StyleSheet.create({
  ...
  playerHud: { marginLeft: 64, marginRight: 92, marginTop: 22, minHeight: 68, paddingLeft: 64, paddingRight: 14, paddingVertical: 9, borderRadius: 18, backgroundColor: 'rgba(235,248,255,0.72)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.72)', flexDirection: 'row', alignItems: 'center', shadowColor: '#075985', shadowOpacity: 0.16, shadowRadius: 16, shadowOffset: { width: 0, height: 8 } },
  avatarWrap: { position: 'absolute', left: -46, top: -5, width: 78, height: 78 },
  ...
  messageButton: { position: 'absolute', right: 22, top: 34, width: 50, height: 50, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.28)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.76)', alignItems: 'center', justifyContent: 'center' },
