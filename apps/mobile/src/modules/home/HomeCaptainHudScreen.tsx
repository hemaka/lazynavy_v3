...
const styles = StyleSheet.create({
  ...
  messageButton: { position: 'absolute', right: 22, top: 28, width: 54, height: 54, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.28)', borderWidth: 2, borderColor: 'rgba(255,255,255,0.76)', alignItems: 'center', justifyContent: 'center' },
